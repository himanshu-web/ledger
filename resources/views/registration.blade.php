...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>Supply Form</h1>
          <p>Sample forms</p>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Enter Shop Detail</h3>
            <div class="tile-body">
              <form>
                <div class="form-group">
                  <label class="control-label">Name Of Shop <b style='color:red' >*</b></label>
                  <input name='shop' class="form-control" type="text" placeholder="Enter Shop Name">
                </div>
                <div class="form-group">
